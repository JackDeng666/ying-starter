...
CREATE TABLE `sys_permission`  (
  ...
  `status` enum('1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '2',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `sort` int NOT NULL DEFAULT 0,
  `mpath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `IDX_ba9809c4237d793d905045f04e`(`code` ASC) USING BTREE,
  INDEX `FK_e8accc6334cdf4e3de9f7c4a426`(`parentId` ASC) USING BTREE,
  CONSTRAINT `FK_e8accc6334cdf4e3de9f7c4a426` FOREIGN KEY (`parentId`) REFERENCES `sys_permission` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
...
CREATE TABLE `sys_permissions_roles`  (
  `sysPermissionId` int NOT NULL,
  `sysRoleId` int NOT NULL,
  PRIMARY KEY (`sysPermissionId`, `sysRoleId`) USING BTREE,
  INDEX `IDX_2b7724e54fff3f6cca2f6062ef`(`sysPermissionId` ASC) USING BTREE,
  ...
  CONSTRAINT `FK_2b7724e54fff3f6cca2f6062efa` FOREIGN KEY (`sysPermissionId`) REFERENCES `sys_permission` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
