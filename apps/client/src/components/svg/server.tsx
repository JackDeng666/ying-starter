...
export const ServerSvg = ({ className }: ClassNameProps) => {
  return (
    <svg
    ...
    >
      ...
      <rect x="271.60911" y="150" width="16" height="16" fill="hsl(var(--primary))" opacity="0.4" />
      <rect x="294.60911" y="150" width="16" height="16" fill="hsl(var(--primary))" opacity="0.8" />
      <rect x="317.60911" y="150" width="16" height="16" fill="hsl(var(--primary))" />
      <rect x="271.60911" y="251" width="16" height="16" fill="hsl(var(--primary))" opacity="0.4" />
      <rect x="294.60911" y="251" width="16" height="16" fill="hsl(var(--primary))" opacity="0.8" />
      <rect x="317.60911" y="251" width="16" height="16" fill="hsl(var(--primary))" />
      <rect x="271.60911" y="352" width="16" height="16" fill="hsl(var(--primary))" opacity="0.4" />
      <rect x="294.60911" y="352" width="16" height="16" fill="hsl(var(--primary))" opacity="0.8" />
      <rect x="317.60911" y="352" width="16" height="16" fill="hsl(var(--primary))" />
