...
import Character6 from '@/admin/assets/images/characters/character_6.png'
import MotionContainer from '@/admin/components/animate/motion-container'
import { varBounce } from '@/admin/components/animate/variants/bounce'
import { useThemeToken } from '@/admin/theme/hooks'

const { VITE_APP_HOMEPAGE: HOMEPAGE } = import.meta.env

export default function Page404() {
  const { colorBgBase, colorTextBase, colorPrimary, colorPrimaryActive, colorPrimaryTextActive, colorPrimaryHover } =
    useThemeToken()
  return (
    <div className="m-auto max-w-[400px]">
      <MotionContainer className="flex flex-col items-center justify-center px-2">
        ...
        <NavLink to={HOMEPAGE} style={{ background: colorTextBase, color: colorBgBase }} className="rounded-md p-4">
          Go to Home
        </NavLink>
      </MotionContainer>
    </div>
